...
const SignIn: React.FC<logedInProps> = ({setIsLogedIn}) => {
    ...
    const userData: UserData = storedData ? JSON.parse(storedData) : {email: '',password: '', name: '', lastName: ''};
        ...
        <div className="form__container">
            <div className="signup__input__grp signin__input__grp">
                <div className="input__container">
                    ...
                    <Button onClick={toggleSignIn}   variant="contained" className="btn__signin" endIcon={<ArrowForwardIcon/>}>
                        Sign in
                    </Button>
                    {errorMessage && (<h5 className="error">{errorMessage}</h5>)}   
                    <NavLink className="link" to="/sign-up">Already have an account? <span>Sign Up</span></NavLink>
                </div>
            </div>
            <div className="signup__info__grp">
                <div className="signin__info__container">
                    <div className="info__logo__grp">
                        <h1>Kodix</h1>
                        <div className="icon__pro"><h5>PRO</h5></div>
                    </div>
                    <p>Unlimited traffic, strategic <br /> support, and AI-driven upsells</p>
                    <h4>Learn More</h4>
                </div>
            </div>
        </div>
